	...
	position="bottom" :canCloseByShade="canCloseByShade">
		...
		@tap.stop.prevent="stopfun">
			...
			:style="{width:width+'rpx', height:(height+100)+'rpx', borderRadius:borderRadius}">
				<text class="gui-action-sheet-title gui-block-text gui-border-b fb" 
				...
				:style="{width:width+'rpx', height:height+'rpx', paddingTop:'20rpx', paddingBottom:'20rpx'}">
					...
					:style="{ color:listColor, lineHeight:listLineHeight, fontSize:listFontSize}">{{item.title}}</text>
...
<style scoped>
.gui-action-sheet-title{text-align:center; font-size:28rpx; line-height:100rpx; height:100rpx;}
</style>
