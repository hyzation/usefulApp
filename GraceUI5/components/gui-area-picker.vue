...
export default{
	...
	props : {
		...
		cancelClass    : { type : String, default : 'c999999' },
		confirmText    : { type : String, default : '确定' },
		confirmClass   : { type : String, default : 'cFF4F00' },
...
.gap-header-btn{width:200rpx; line-height:38rpx; height:38rpx; font-size:30rpx;}
.gap-main{width:750rpx; height:500rpx;}
.gap-item{height:35px; font-size:30rpx; line-height:35px; overflow:hidden; text-align:center;}
</style>