<template>
	<view class="gui-img gui-flex gui-align-items-center gui-justify-content-center" 
	:style="{width:width+'rpx', height:height == 0 ? imgHeight+'rpx' : height+'rpx', borderRadius:borderRadius}">
		<image :src="src" @load="imgLoad" @error="error" :mode="mode"
