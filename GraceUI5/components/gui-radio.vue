<template>
	...
	@tap.stop="changeStatus">
		...
		<image v-if="status" class="wh30" mode="aspectFit" src="@/static/images/zheng/checked.png"></image>
		<image v-else class="wh30" mode="aspectFit" src="@/static/images/zheng/check.png"></image>
...
.gui-radio-lable{margin-left:10rpx;}
.wh30{width:30rpx;height:30rpx;}
</style>