		...
		<view slot="gHeader">
			<view class="gui-flex gui-nowrap gui-rows gui-align-items-center">
				...
				<view class="gui-flex1 gui-text-center">
					<text class="f36 gui-ellipsis">消费券释放</text>
				</view>
			</view>
		</view>
		<view slot="gBody">
			<view class="bgffc2a6-ffdfd1 gui-border-radius card mt20 mlr20 mb10">
				<view class="lh100 gui-flex gui-align-items-center gui-space-between"><text class="f34 plr20 ml20">消费券释放</text> <text class="cFF4F00 f50 plr20 fb">{{ FC_val }}%</text></view>
			</view>
			<view>
			...
			<view class="w710 mlr20 mt30 pb30 gui-relative borderBottom">
				<view class="gui-flex gui-align-items-center gui-space-between">
					<view class=""><text class="f34 fb">释放明细</text><text class="f24 c99 ml20">展示最近1个月</text></view>
				</view>
			</view>
