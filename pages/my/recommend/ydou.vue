	...
	<gui-page :isLoading="pageLoading" ref='guiPage' :customHeader="true">
		<view slot="gHeader">
			<view class="gui-flex gui-nowrap gui-rows gui-align-items-center">
				...
				<view class="gui-flex1 gui-text-center">
					<text class="f36 gui-ellipsis">推荐收益</text>
				</view>
				<view class="pr30">
		...
		<view slot="gBody">
			<view class="bgffc2a6-ffdfd1 gui-border-radius card mt20 mlr20 mb10">
				<view class="lh100 gui-flex gui-align-items-center gui-space-between"><text class="f34 plr20 ml20">推荐收益</text> <text class="cFF4F00 f50 plr20 fb">{{userInfo.yBean}}</text></view>
			</view>
