<template>
	...
	:customHeader="true" statusBarStyle="background-color:#FFCB33;" headerStyle="background-color:#FFCB33;color:#000000;">
		<view slot="gHeader">
			<view class="gui-flex gui-nowrap gui-rows gui-align-items-center">
				...
				<view class="gui-flex1 gui-text-center">
					<text class="f36 gui-ellipsis">爱·生活 乐惠商城</text>
				</view>
		...
		<view slot="gBody">
			...
			<view class="p20 bgFF">
				<gui-switch-navigation :items="navList" @change="navChange" keyStr="title" color="#000000"
					...
					activeDirection="center" activeColor="#FFCB33" activeLineBg="linear-gradient(to right, #FFCB33, #FFCB33)" 
