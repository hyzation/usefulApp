	...
	<gui-page :isLoading="pageLoading" ref="guiPage">
		<view slot="gBody">
			<block v-for="(item,index) in productList" :key="index">
				<navigator :url="'/pages/home/content?type=notice&id='+item.id" hover-class="" class="p30 gui-relative borderTop">
					<view class="f28 line2">
						{{item.title}}
					</view>
					<view class="f24 c999999 mt20">{{item.created_at}}</view>
				</navigator>
			</block>
